 ...
 * audit process.
 *
 * @author    Steve Guns <steve@hafizhassan.com>
 * @package   com.hafizhassan.yii2.audit
 * @copyright 2014-2015 B&E DeZign
 */

namespace hafizhassan\yii2\audit;

use hafizhassan\yii2\audit\components\panels\Panel;
 ...
 *     'modules' => [
 *        'audit' => 'hafizhassan\yii2\audit\Audit',
 *     ]
 *   or optionally with configuration:
 *     'modules' => [
 *        'audit' => [
 *            'class' => 'hafizhassan\yii2\audit\Audit',
 *            'ignoreActions' => ['debug/*']
 *     ]
 * - If you want to auto track actions, be sure to add the module to the application bootstrapping:
 *    'bootstrap' => ['audit'],
 *
 * @package hafizhassan\yii2\audit
 * @property AuditEntry $entry
 *
 * @method void data($type, $data)                                                                      @see ExtraDataPanel::trackData()
 * @method \hafizhassan\yii2\audit\models\AuditError exception(\Exception $exception)                      @see ErrorPanel::log()
 * @method \hafizhassan\yii2\audit\models\AuditError errorMessage($message, $code, $file, $line, $trace)   @see ErrorPanel::logMessage()
 */
class Audit extends Module
{
    ...
    private $_corePanels = [
        ...
        'audit/request'    => ['class' => 'hafizhassan\yii2\audit\panels\RequestPanel'],
        'audit/db'         => ['class' => 'hafizhassan\yii2\audit\panels\DbPanel'],
        'audit/log'        => ['class' => 'hafizhassan\yii2\audit\panels\LogPanel'],
        'audit/asset'      => ['class' => 'hafizhassan\yii2\audit\panels\AssetPanel'],
        'audit/config'     => ['class' => 'hafizhassan\yii2\audit\panels\ConfigPanel'],
        'audit/profiling'  => ['class' => 'hafizhassan\yii2\audit\panels\ProfilingPanel'],

        // Special other panels
        'audit/error'      => ['class' => 'hafizhassan\yii2\audit\panels\ErrorPanel'],
        'audit/javascript' => ['class' => 'hafizhassan\yii2\audit\panels\JavascriptPanel'],
        'audit/trail'      => ['class' => 'hafizhassan\yii2\audit\panels\TrailPanel'],
        'audit/mail'       => ['class' => 'hafizhassan\yii2\audit\panels\MailPanel'],
        'audit/extra'      => ['class' => 'hafizhassan\yii2\audit\panels\ExtraDataPanel'],
        'audit/curl'       => ['class' => 'hafizhassan\yii2\audit\panels\CurlPanel'],
        'audit/soap'       => ['class' => 'hafizhassan\yii2\audit\panels\SoapPanel'],
    ];
    ...
    /**
     * @var \hafizhassan\yii2\audit\models\AuditEntry If activated this is the active entry
     */
    private $_entry = null;
