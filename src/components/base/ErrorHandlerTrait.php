...
namespace hafizhassan\yii2\audit\components\base;

use hafizhassan\yii2\audit\Audit;
use hafizhassan\yii2\audit\models\AuditError;
use hafizhassan\yii2\audit\panels\ErrorPanel;
use Exception;
use Yii;

/**
 * ErrorHandlerTrait
 * @package hafizhassan\yii2\audit\components\base
 */
