...
namespace hafizhassan\yii2\audit\models;

use hafizhassan\yii2\audit\Audit;
use hafizhassan\yii2\audit\components\db\ActiveRecord;
use hafizhassan\yii2\audit\components\Helper;
use Yii;
...
/**
 * AuditEntry
 * @package hafizhassan\yii2\audit\models
 *
 * @property int               $id
